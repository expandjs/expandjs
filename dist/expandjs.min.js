...
!function(){"use strict";var r=require("../assert/assertArgument"),e=require("../tester/isDefined"),t=require("../array/slice"),u=require("../caster/toArray");module.exports=function(s,a){return r(s=u(s),1,"Arrayable"),t(arguments,1).forEach(function(r){e(r=u(r))&&r.forEach(function(r){s.push(r)})}),s}}();
...
!function(){"use strict";var r=require("lodash"),e=require("../assert/assertArgument"),a=require("../array/concat"),t=require("../array/slice"),u=require("../caster/toArray");module.exports=function(s,i){return e(s=u(s),1,"Arrayable"),r.pull.apply(r,a([s],t(arguments,1)))}}();
...
!function(){"use strict";var r=require("../assert/assertArgument"),e=require("../constructors/Deferred"),t=require("../array/fit"),n=require("../tester/isArray"),i=require("../tester/isBindable"),u=require("../tester/isFunction"),o=require("../caster/toArray");module.exports=function(s,a,c){r(s=o(s),1,"Arrayable"),r(u(a),2,"Function"),r(i(c),3,"Array, Function or Object");var f,l,q,y=new e,h=y.promise;if(n(s=t(s,a.length),!0)){for(q=s.length-1,l=q;l>=0;l-=1)if(u(s[l])){for(f=s[l];q>l;l+=1)s[l]=void 0;break}s[q]=function(r,e){y[r?"reject":"resolve"](r||e)}}return a.apply(c,s),f&&(h=h.then(function(r){return f(null,r),r})),f&&(h=h["catch"](function(r){throw f(r,null),r})),h}}();
...
!function(){"use strict";var e=require("lodash"),r=require("../function/ary"),t=require("../assert/assertArgument"),i=require("../tester/isObject"),s=require("../collection/filter");module.exports=function(u,n){return t(i(u),1,"Object"),e.assign.apply(e,s(arguments,r(i,1)))}}();
