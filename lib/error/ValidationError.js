...
(function () {
     ...
     * @constructor
     */
    module.exports = function ValidationError(key, type) { CustomError.call(this, 'ValidationError', key, 'must be ' + type); };
    module.exports.prototype = Object.create(CustomError.prototype, {constructor: {configurable: true, value: module.exports, writable: true}, name: {value: 'ValidationError', writable: true}});
