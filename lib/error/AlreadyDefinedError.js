...
(function () {
     ...
     * @constructor
     */
    module.exports = function AlreadyDefinedError(key) { CustomError.call(this, 'AlreadyDefinedError', key, 'is already defined'); };
    module.exports.prototype = Object.create(CustomError.prototype, {constructor: {configurable: true, value: module.exports, writable: true}, name: {value: 'AlreadyDefinedError', writable: true}});
