...
/**
 * Returns `string` trimmed and converted to [camel case](https://en.wikipedia.org/wiki/Camel_case).
 *
 * ```js
 ...
 * @since 1.0.0
 * @category string
 * @description Returns `string` trimmed and converted to camel case
...
module.exports = function camelCase(string) {
    ...
    return string ? _camelCase(string.trim()) : '';
};
