...
/**
 * Returns `string` trimmed and converted to [pascal case](https://en.wikipedia.org/wiki/Letter_case#Special_case_styles).
 *
 * ```js
 ...
 * @since 1.0.0
 * @category string
 * @description Returns `string` trimmed and converted to pascal case
...
module.exports = function pascalCase(string) {
    ...
    return string ? _capitalize(_camelCase(string.trim())) : '';
};
