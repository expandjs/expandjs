...
/**
 * Returns `string` trimmed and converted to [kebab case](https://en.wikipedia.org/wiki/Letter_case#Special_case_styles).
 *
 * ```js
 ...
 * @since 1.0.0
 * @category string
 * @description Returns `string` trimmed and converted to kebab case
...
module.exports = function kebabCase(string) {
    ...
    return string ? _kebabCase(string.trim()) : '';
};
