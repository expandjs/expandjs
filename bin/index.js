...
(function (global, browser) {
    ...
    exp.isBase62 = isBase62 = function isBase62(value) {
        if (isString(value)) {
            var check = /(?!([0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ]))/g;
            return value.match(check).length === 1;
        }
        return false;
    };
